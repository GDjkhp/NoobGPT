...
| :-------- | ----------: | ----------: | ----------: | :--------------------------------- |
| NOOBGPT   | ?           | ?ms         | ??:??:??:?? | multipurpose / [invite link](https://discord.com/oauth2/authorize?client_id=1090254079609020447&permissions=633731823291392&scope=applications.commands%20bot) |
| KAGURA    | ?           | ?ms         | ??:??:??:?? | multipurpose / [invite link](https://discord.com/oauth2/authorize?client_id=1120259379715903508&permissions=633731823291392&scope=applications.commands%20bot) |
| MOOSIC    | ?           | ?ms         | ??:??:??:?? | music only / [invite link](https://discord.com/api/oauth2/authorize?client_id=1073823671392686162&permissions=412588788736&scope=applications.commands%20bot)  |
...
### Use AI responsibly ⚠
<marquee>Content generated by AI services, including your prompts, are managed and collected by them. Read their terms of services and privacy policies before using them. Proceed with caution and happy prompting!</marquee>
<br>
<br>
Bot by GDjkhp
<br>
© The Karakters Kompany, 2026